      ...
      <div class="mt-5">      
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              <li v-for="index in imagenes.length" :key="index" data-target="#carouselExampleIndicators" :data-slide-to="(index - 1)" :class="{ active: (index - 1) === indiceImagenActual }"></li>
            </ol>
            ...
            <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev" @click="retroceder">
            ...
            <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next" @click="avanzar">
      ...
      <div id="inpIdCena" class="mt-5" style="display: none">  
        ...
        <div class="d-flex justify-content-center">
            <form @submit.prevent="addCena">
              <input type="number" id="addIdCena" name="addIdCena" autocomplete="off" 
              class="input d-inline-block mx-4" placeholder="ID de La Cena" v-model="addIdCena"
              ref="addIdCena"  @focus="resetEstado" @keypress="resetEstado" />
